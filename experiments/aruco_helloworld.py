...
def get_matrix(filename):
    """Read a serialized numpy matrix from a file.
...
def main(video_device, camera_matrix_file, distortion_matrix_file):
    video_cap = vidio.get_video_cap(video_device)
    camera_matrix = get_matrix(camera_matrix_file)
    distortion_matrix = get_matrix(distortion_matrix_file)
...
if __name__ == "__main__":
    ...
    distortion_matrix_file = sys.argv[3]

    main(video_device, camera_matrix_file, distortion_matrix_file)
